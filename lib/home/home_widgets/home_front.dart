        ...
        child: Row(
          ...
          children: <Widget>[
            IconButton(
              ...
              onPressed: () async {
                await _launchURL("https://facebook.com/gdgpeshawar");
              },
            ),
            IconButton(
              icon: Icon(FontAwesomeIcons.twitter),
              onPressed: () async {
                await _launchURL("https://twitter.com/GDGPeshawar");
              },
            ),
            IconButton(
              icon: Icon(FontAwesomeIcons.instagram),
              onPressed: () async {
                _launchURL("https://instagram.com/gdgpeshawar");
              },
            ),
            ...
            IconButton(
              ...
              onPressed: () async {
                var emailUrl =
                    '''mailto:gdgpeshawar@gmail.com?subject=Support Needed For 
                    DevFest App''';
